...
public:
    ...
    DynArray(DynArray &&o) : ptr_(o.ptr_), n_(o.n_)
    {
        o.ptr_ = nullptr;
        o.n_ = 0;
    }
...
public:
    using RawPtrType =
        std::conditional_t<std::is_const_v<T>, const uint8_t *, uint8_t *>;
    ...
    public:
        ...
        reference operator*() const { return *fromRaw(ptr_); }
    ...
    iterator begin() { return iterator(raw_data_, byte_stride_); }
    iterator end()
    {
